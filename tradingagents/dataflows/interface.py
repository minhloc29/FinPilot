...
from .vnstock import (
    get_stock_data_vnstock,
    get_stock_stats_indicators_window_vnstock,
...
from .vnstock_news import get_news_vnstock, get_global_news_vnstock
...
VENDOR_METHODS = {
    # core_stock_apis
    "get_stock_data": {
        "vnstock": get_stock_data_vnstock,
        "alpha_vantage": get_alpha_vantage_stock,
        "yfinance": get_YFin_data_online,
    },
    # technical_indicators
    "get_indicators": {
        "vnstock": get_stock_stats_indicators_window_vnstock,
    ...
    # news_data
    "get_news": {
        "vnstock": get_news_vnstock,
        "alpha_vantage": get_alpha_vantage_news,
        "yfinance": get_news_yfinance,
    },
    "get_global_news": {
        "vnstock": get_global_news_vnstock,
